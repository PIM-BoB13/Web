...
<template>
  <CRow :xs="{ gutter: 4 }">
    <CCol :sm="6" :xl="4" :xxl="3">
      <CWidgetStatsA color="primary-gradient">
        <template #value
          >26K
    ...
    <CCol :sm="6" :xl="4" :xxl="3">
      <CWidgetStatsA color="info-gradient">
        <template #value
          >$6.200
          <span class="fs-6 fw-normal"> (40.9% <CIcon icon="cil-arrow-top" />) </span>
        </template>
        <template #title>{{ t('income') }}</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle color="transparent" class="p-0 text-white" :caret="false">
              <CIcon icon="cil-options" class="text-white" />
    ...
    <CCol :sm="6" :xl="4" :xxl="3">
      <CWidgetStatsA color="warning-gradient">
        <template #value
          >2.49%
    ...
    <CCol :sm="6" :xl="4" :xxl="3">
      <CWidgetStatsA color="danger-gradient">
        <template #value
          >44K
