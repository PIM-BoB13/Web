        ...
        sections: [
          {
            ...
            controls: [
              {
                id: '1.1.1.1',
                description: '정보보호 및 개인정보보호 관리체계의 수립 및 운영활동을 지원하고 관리감독을 수행하기 위한 정보보호 및 개인정보보호 위원회 등의 조직을 구성하고 있는가?',
          ...
          },
          {
            ...
            controls: [
              {
                id: '1.1.2.1',
                description: '정보보호 및 개인정보보호 관리체계의 수립 및 운영을 위해 고위 경영진 수준의 정보보호 최고책임자와 개인정보 보호책임자를 지정하고 있는가?',
                policyReadiness: { completed: 1, total: 2 },
                evidenceReadiness: { completed: 1, total: 1 },
                owner: '김철수'
              }
